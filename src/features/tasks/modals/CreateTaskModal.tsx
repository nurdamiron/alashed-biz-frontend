...
const CreateTaskModal = () => {
  ...
  const handleCreate = () => {
    ...
    addTask({
      ...
      priority,
      status: 'К выполнению',
      deadline: selectedDate.toLocaleDateString('ru-RU', { day: 'numeric', month: 'short' }),
      time: selectedTime,
  ...
  const timeOptions = ['09:00', '10:00', '12:00', '14:00', '16:00', '18:00', '20:00'];
  ...
  return (
    <div className="relative flex h-screen w-full flex-col bg-background-light dark:bg-background-dark overflow-hidden z-50">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-6 py-4 space-y-8 pb-48">
        ...
        <div className="space-y-4">
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-primary/20 to-blue-600/20 rounded-[2.5rem] blur opacity-25 group-focus-within:opacity-100 transition duration-500"></div>
          ...
          <div className="bg-white dark:bg-surface-dark rounded-[2.5rem] p-6 shadow-sm border border-gray-100 dark:border-white/5 space-y-6 transition-all duration-500">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-2xl bg-purple-500/10 text-purple-500 flex items-center justify-center border border-purple-500/20 shadow-inner">
                  <Icon name="event" className="text-[24px]" />
                </div>
      ...
      <div className="flex-none p-6 pb-12 bg-gradient-to-t from-background-light dark:from-background-dark via-background-light dark:via-background-dark to-transparent z-10">
        <button
