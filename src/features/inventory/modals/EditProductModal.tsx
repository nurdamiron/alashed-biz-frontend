...
const EditProductModal = () => {
  ...
  useEffect(() => {
    if (product) {
      ...
      setIsKit(!!product.kitComponents && product.kitComponents.length > 0);
  ...
  if (!product) {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-background-light dark:bg-background-dark text-slate-900 dark:text-white">
        <Icon name="inventory_2" className="text-[64px] text-gray-300 dark:text-gray-600 mb-4" />
        <p className="text-lg font-bold">Товар не найден</p>
