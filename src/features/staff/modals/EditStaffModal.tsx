  ...
  if (!employee) {
    return (
      <div className="flex items-center justify-center h-full bg-background-light dark:bg-background-dark">
        <p className="text-gray-400">Сотрудник не найден</p>
      </div>
    );
  }
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-surface-dark rounded-[2rem] p-5 border border-gray-100 dark:border-white/5">
            ...
            <div className="flex items-center gap-4">
              <div>
                <p className="text-2xl font-black text-primary">{employee.activeTasks}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Активных задач</p>
              </div>
            </div>
          </div>
        </div>
